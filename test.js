	  ...
	  switch (chartType) {
		...
		//   let iess = 1;
		  ...
		  const externalTooltipHandler3 = (context) => {
			...
			if (tooltip.body) {
			  ...
			  bodyLines.forEach((body, i) => {
				...
				const tdbtn = document.createElement("div");
				tdbtn.classList.add("tdbtnc")
				tdbtn.onclick = function () {
				  // console.log("Trigger event here LINE");
					//   instance.triggerEvent('specialnewclick')
				instance.triggerEvent("donutchartclick")
				};
				tdbtn.style.position = "relative";
				tdbtn.style.marginTop = "4px";
				// tdbtn.style.borderWidth = "1px";
				...
				tdbtn.style.fontSize = "16px";
				tdbtn.style.verticalAlign = "bottom";
                // console.log(chart.boxes[0].legendItems[
				// 	chart.tooltip.dataPoints[0].dataIndex
				//   ])
				var resE =
				  chart.boxes[0].legendItems[
			  ...
			  tableRoot.style.borderWidth = "0px";
			  tableRoot.style.borderColor = "#000";
			//   tableBody.style.backgroundColor = "rgba(255, 0, 0, 0.7)";
		  ...
		  chartOptions = {
			...
			//   ) {
			// 	// console.log("Trigger event here DONUT");
		...
		case "lineNew":
			...
			const externalTooltipHandlernew = (context) => {
			  ...
			  tooltipEl.style.paddingLeft = "6px";
			  tooltipEl.style.paddingRight = "6px";
			  var extJAYCY = 0;
			  var extJAYCYent = 0;
			  tooltipEl.addEventListener("mouseover", (e) => {
				//  testInstancenew = 0;
